![Qwiic ENS160 - Python Package](docs/images/gh-banner.png "qwiic ENS160 Python Package")
...
```sh
mprmeote mip install github:sparkfun/qwiic_ens160_py@examples
```
...
See the examples directory for more detailed use examples and [examples/README.md](https://github.com/sparkfun/qwiic_ens160_py/blob/main/examples/README.md) for a summary of the available examples.
